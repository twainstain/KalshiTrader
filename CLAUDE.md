...
**`README.md` is stale.** It describes the prior EVM cross-DEX arbitrage bot (Quick Start, CLI options, 12-chain support, FlashArbExecutor, 202-test suite). That is archival; do not cite as current. This file (`CLAUDE.md`) wins when they disagree. `README.md` will be rewritten once Phase 1 code lands.
...
## Signup / platform links (so future Claude doesn't guess)
